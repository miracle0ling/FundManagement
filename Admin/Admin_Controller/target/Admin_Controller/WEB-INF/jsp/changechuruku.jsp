            ...
            <div class="main-content-inner">
                ...
                <div align="center">
                    <table class="table table-hover table-bordered">
                        ...
                        <form action="./updatechuruku?zid=${libraryList.zid}" method="post">
                            <tr>
                                <td><input type="text" id="tname" name="tname" value="${libraryList.tname}"></td>
                                <td><input type="text" id="dw" name="dw" value="${libraryList.dw}"></td>
                                <td><input type="text" id="unitprice" name="unitprice" value="${libraryList.unitprice}"></td>
                                <td><input type="text" id="money" name="money" value="${libraryList.money}"></td>
                                <td><input type="text" id="quantity" name="quantity" value="${libraryList.quantity}"></td>
                                <td>
