            ...
            <div class="main-content-inner">
                ...
                <div class="page-content">
                    ...
                    <div class="page-header">
                        <h1>
                            大创项目<span id="errorMessage" style="color:red;">${errorMessage}</span>
                        </h1>
                    </div><!-- /.page-header -->
                    ...
                    <div class="table-responsive">
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover text-nowrap">
                                <tr align="center">
                                    <td class="hidden-480">项目编号</td>
                                    <td class="hidden-480">项目级别</td>
                                    <td class="hidden-480">项目负责人</td>
                                    <td>负责人电话</td>
                                    <td>指导老师</td>
                                    <td>指导老师电话</td>
                                    <td>省拨</td>
                                ...
                                <c:forEach items="${projectlist}" var="projectlist">
                                        <tr align="center">
                                            <td>${projectlist.proid}</td>
                                            <td>${projectlist.level}</td>
                                            <td>${projectlist.principal}</td>
                                            <td>${projectlist.stutel}</td>
                                            <td>${projectlist.teacher}</td>
                                            <td>${projectlist.teatel}</td>
                                            <td><fmt:formatNumber type="number" value="${projectlist.conmoney} " minFractionDigits="2"/></td>
                                            <td><fmt:formatNumber type="number" value="${projectlist.total}" minFractionDigits="2"/></td>
                                            <td><fmt:formatNumber type="number" value="${projectlist.usable}" minFractionDigits="2"/></td>
                                            <td><a href="./projectindex?proid=${projectlist.proid}&pid=${projectlist.proid}">查看</a></td>
                                        </tr>
                                </c:forEach>
                            </tbody>
