    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <form class="form-inline" style="float:left;" action="./selectleibie">
                ...
                <div class="table-responsive">
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover text-nowrap">
                        ...
                        <tbody>
                            <c:forEach items="${billList1}" var="billList1" varStatus="num">
                                <tr>
                                    <td>${num.index+1}</td>
                                    <td>${billList1.time}</td>
                                    <td>${billList1.leibie}</td>
                                    <td>${billList1.tname}</td>
                                    <td>${billList1.type}</td>
                                    <td><fmt:formatNumber type="number" value="${billList1.amoney} " minFractionDigits="2"/></td>
                                    <td>${billList1.people}</td>
                                    <td>${billList1.tel}</td>
                                    <td>${billList1.baoxiao}</td>
                                    <td>
                                        <c:if test="${billList1.status == 0}">
                                            <span class="label label-sm label-warning">申请中</span>
                                        </c:if>
                                        <c:if test="${billList1.status == 1}">
                                            <span class="label label-sm label-success arrowed">已同意</span>
                                        </c:if>
                                    </td>
                                    <td>
                                        <c:if test="${billList1.status == 0}">
                                            <a onClick="return confirm('确定同意?');" href="./tongyiapplication?id=${billList1.id}&amoney=${billList1.amoney}&pid=${billList1.pid}&leibie=${billList1.leibie}"><span class="label label-sm label-success arrowed">同意</span></a>
                                            <a onClick="return confirm('确定拒绝?');" href="./jujueapplication?id=${billList1.id}"><span class="label label-sm label-inverse arrowed-in-right">拒绝</span></a>
                                            <a href="./changeapplication?id=${billList1.id}&pid=${billList1.pid}&leibie=${billList1.leibie}&tname=${billList1.tname}&type=${billList1.type}
                                                &amoney=${billList1.amoney}&people=${billList1.people}&tel=${billList1.tel}&baoxiao=${billList1.baoxiao}">
                                                <span class="label label-sm label-info arrowed-in-right" data-toggle="modal" data-target="#exampleModal">修改</span></a>
                                        </c:if>
                                    </td>
                                    <td>
                                        <c:if test="${billList1.status == 0&&billList1.baoxiao == '有'}">
                                            <a href="./changechuruku?rid=${billList1.rid}"><span class="label label-sm label-info arrowed-in-right">修改</span></a>
                                            <a href="./churukurid?rid=${billList1.rid}"><span class="label label-sm label-inverse arrowed-in-right">查看</span></a>
                                        </c:if>
                                    </td>
                                </tr>
                            </c:forEach>
