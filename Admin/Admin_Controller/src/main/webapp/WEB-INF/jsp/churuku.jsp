...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div align="center">
                <form class="form-inline" action="${pageContext.request.contextPath}/churukurid">
                    <div class="form-group">
                        <label for="exampleInputName1">发票单id</label>
                        <input type="text" class="form-control" id="exampleInputName1"  name="rid">
                    </div>
            ...
            <font size="3" style="margin-left: 20px;">单位名称：国家大学生文化素质教育基地办公室</font>
            ...
            <table class="table table-bordered table-striped">
                ...
                <c:forEach items="${libraryList}" var="libraryList" varStatus="num">
                <tr align="center">
                    <td><h4>${num.index+1}</h4></td>
                    <td><h4>${libraryList.tname}</h4></td>
                    <td><h4>${libraryList.dw}</h4></td>
                    <td><h4>${libraryList.unitprice}</h4></td>
                    <td><h4>${libraryList.money}</h4></td>
                    <td><h4>${libraryList.quantity}</h4></td>
                </tr>
                </c:forEach>
                <tr align="center">
                    <td colspan="3"><font size="5">合计：</font></td>
                    <td colspan="3"><font size="5">${bill.amoney}(元)</font></td>
                </tr>
            </table>
            </div>
            <a type="button"
               ...
               href="./exportword?rid=${bill.rid}">
                <i class="ace-icon fa fa-file-o bigger-100 green"></i>
                <font size="4">导出表格</font>
            </a>
        </div>
    </div><!-- /.main-content -->
</div><!-- /.main-container -->
