                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="userid">${project.proname}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="username">${project.proid}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="faculty">${project.principal}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="faculty"><fmt:formatNumber type="number" value="${project.total}" minFractionDigits="2"/></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="faculty"><fmt:formatNumber type="number" value="${project.used}" minFractionDigits="2"/></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="faculty"><fmt:formatNumber type="number" value="${project.usable}" minFractionDigits="2"/></span>
                                                </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> 校拨经费</div>

                                                <div class="profile-info-value">
                                                    <span class="editable" id="faculty"><fmt:formatNumber type="number" value="${project.schmoney}" minFractionDigits="2"/></span>
                                                </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> 省拨经费</div>

                                                <div class="profile-info-value">
                                                    <span class="editable" id="faculty"><fmt:formatNumber type="number" value="${project.conmoney}" minFractionDigits="2"/></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
