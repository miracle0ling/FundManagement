                                ...
                                <div class="widget-main">
                                    ...
                                    <form action="${pageContext.request.contextPath}/login"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                <label class="inline">
                                                    <a href="forgetpassword">激活密码</a>
                                                </label>

                                                <label class="inline">
                                                    <a href="teacherreg">教师激活密码</a>
                                                </label>
                                            ...
                                            <div class="block clearfix">
                                                <span class="blue lighter" style="float: left;"><i class="ace-icon fa fa-phone"></i>管理员联系电话：18104260073</span>
                                            </div>
                                            <div class="space-4"></div>
                                        </fieldset>
                                    </form>
