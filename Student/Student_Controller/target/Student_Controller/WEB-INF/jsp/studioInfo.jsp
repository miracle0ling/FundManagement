                                    ...
                                    <div class="col-xs-12 col-sm-3 center">
                                                ...
                                                <div class="inline position-relative">
                                                    <a href="#" class="user-title-label dropdown-toggle"
                                                       data-toggle="dropdown">
                                                        <span class="white">${studio.sname}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix" style="width: 100%;">
                                            <div class="grid2" style="margin-left: 25%;">
                                                <span class="bigger-175 blue">￥${studio.submoney}</span>
                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="sid">${studio.sid}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="sname">${studio.sname}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="principal">${studio.principal}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="a">${studio.dalymoney}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="b">${studio.submoney}</span>
                                                </div>
                                            </div>
                                        </div>
