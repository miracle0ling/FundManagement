                ...
                <div class="message-footer clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <ul class="pagination middle">
                            ...
                            <li>
                                <span>
                                    <input value="${thisPage}" maxlength="3" type="text" readonly="readonly" />
                                </span>
                            </li>
                            <c:if test="${thisPage * 8 < noticeCount}">
                                <li>
                                    <a href="./notice?page=${nextPage}">
