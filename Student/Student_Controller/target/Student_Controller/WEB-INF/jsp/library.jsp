...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div>
            ...
            <p style="font-size: x-large;color: blue" id="allmoney" class="allmoney"></p>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        tr.innerHTML =
            ...
            "                        <td><input name=\"money\" required placeholder=\"税前金额（发票单上对应金额）\" onblur='countmoney()' value='0' class='money'></td>\n" +
            "                        <td><input name=\"tax\" required onblur='countmoney()' value='0' class='tax'></td>\n" +
            "                        <td>\n" +
            "                            <div class=\"col-xs-12\">\n" +
            "                                <a onclick=\"del(this)\"><span>删除</span></a>\n" +
            "                            </div>\n" +
...
<script type="text/javascript">
    function countmoney() {
        var money = [];
        var tax = [];
        // var allmoney = document.getElementById("allmoeny");
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/ajaxgetcount",
            data:{"money":money,"tax":tax,"count":$("count").val()},
            type:"post",
