                                    ...
                                    <div class="col-xs-12 col-sm-3 center">
                                                ...
                                                <div class="inline position-relative">
                                                    <a href="#" class="user-title-label dropdown-toggle"
                                                       data-toggle="dropdown">
                                                        <span class="white">${project.proname}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="clearfix" style="width: 100%;">
                                            <div class="grid2" style="margin-left: 25%;">
                                                <span class="bigger-175 blue">￥${project.usable}</span>
                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="proid">${project.proid}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="proname">${project.proname}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="principal">${project.principal}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="teacher">${project.teacher}</span>
                                                </div>
                                            </div>

                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> 校拨</div>

                                                <div class="profile-info-value">
                                                    <span class="editable" id="schmoney">${project.schmoney}</span>
                                                </div>
                                            </div>

                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> 省拨</div>

                                                <div class="profile-info-value">
                                                    <span class="editable" id="conmoney">${project.conmoney}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="total">${project.total}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <span class="editable" id="used">${project.used}</span>
                                                </div>
                                            </div>


                                            <c:if test="${project.stutel != null}">
                                                <div class="profile-info-row">
                                                    <div class="profile-info-name"> 联系电话</div>

                                                    <div class="profile-info-value">
                                                        <span class="editable"
                                                              id="telephone">${project.stutel}</span>
                                                    </div>
                                                </div>
                                            </c:if>
                                        </div>
